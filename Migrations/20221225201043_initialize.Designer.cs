...
namespace spotifycrud.Migrations
{
    ...
    [Migration("20221225201043_initialize")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("spotifycrud.Models.Playlist", b =>
                {
                    ...
                    b.Property<int>("PlaylistNameId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("PlaylistNameId");
            ...
            modelBuilder.Entity("spotifycrud.Models.Playlistname", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("spotifycrud.Models.Playlist", b =>
                {
                    b.HasOne("spotifycrud.Models.Playlistname", "Playlistnames")
                        .WithMany("Playlists")
                        .HasForeignKey("PlaylistNameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Playlistnames");
                });
            ...
            modelBuilder.Entity("spotifycrud.Models.Playlistname", b =>
                {
                    b.HasOne("spotifycrud.Models.User", "Users")
                        .WithMany("Playlistnames")
